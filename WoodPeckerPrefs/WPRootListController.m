...
#define PREFS_CHANGED_NN @"com.todayios-cydia.woodpecker.prefschanged"
...
-(void)viewDidLoad{
    ...
    UIImage *headerImage = [[UIImage alloc]
                            initWithContentsOfFile:[[NSBundle bundleWithPath:@"/Library/PreferenceBundles/WoodPeckerPrefs.bundle"] pathForResource:@"icon56" ofType:@"png"]];
    ...
    [headerLabel setText:@"WoodPeckeriOS"];
...
- (NSArray *)specifiers {
    if (!_specifiers) {
        ...
        [altListSpec setProperty:WOODPECKER_IDENTIFIER forKey:@"defaults"];
        ...
        // [appsFilterSelectionSpec setProperty:WOODPECKER_IDENTIFIER forKey:@"defaults"];
